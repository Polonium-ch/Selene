...
int main(int argc, char *argv[])
{
    ...
    // High DPI support is always enabled on our supported Qt versions running
    // under a normal windowing system.
...
#if defined(QT_DEBUG) && !defined(HAVE_LIBPLACEBO_VULKAN)
